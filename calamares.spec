...
%{cmake_kf5} -DWITH_PARTITIONMANAGER:BOOL="ON" -DCMAKE_BUILD_TYPE:STRING="RelWithDebInfo" -DCMAKE_INSTALL_LIBDIR:PATH=%{_lib} ..
popd
...
- Explicitly define CMAKE_INSTALL_LIBDIR to work around FTBFS for now
