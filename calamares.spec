...
%{cmake_kf5} -DWITH_PARTITIONMANAGER:BOOL="ON" -DCMAKE_BUILD_TYPE:STRING="RelWithDebInfo" -DKDE_INSTALL_LIBDIR:PATH=%{_lib} ..
popd
...
- Explicitly define KDE_INSTALL_LIBDIR to work around FTBFS for now
